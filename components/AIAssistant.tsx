...
export default function AIAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: "Hi! I'm your AI food assistant. I can help you with recipes, dietary advice, budget meal planning, and food recommendations. What would you like to know?",
      isUser: false,
      timestamp: new Date(),
    }
  ]);

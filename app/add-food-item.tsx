...
export default function AddFoodItem() {
  ...
  const handleImagePicker = () => {
    ...
    Alert.alert(
      ...
      'Choose an option',
      [
        { text: 'Camera', onPress: () => setImageUri('https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg') },
        { text: 'Gallery', onPress: () => setImageUri('https://images.pexels.com/photos/1279330/pexels-photo-1279330.jpeg') },

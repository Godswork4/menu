...
const foodDatabase: { [key: number]: any } = {
  ...
  4: {
    ...
    price: 3800,
    originalPrice: 4500,
    description: 'Traditional Nigerian Amala (yam flour) served with fresh Ewedu soup, assorted meat, and fish. A true taste of Yoruba cuisine.',
    image: 'https://images.pexels.com/photos/5835353/pexels-photo-5835353.jpeg',
    rating: 4.8,
    reviews: 723,
    chef: {
      name: 'Chef Bisi Adegoke',
      restaurant: 'Yoruba Delights',
      image: 'https://images.pexels.com/photos/3771120/pexels-photo-3771120.jpeg',
      experience: '25 years',
      speciality: 'Yoruba Cuisine',
      rating: 4.9,
    },
    calories: 450,
    prepTime: '20-25 min',
    ...
    ingredients: [
      { name: 'Yam Flour (Amala)', included: true, allergen: false },
      { name: 'Fresh Ewedu Leaves', included: true, allergen: false },
      { name: 'Assorted Meat', included: true, allergen: false },
      { name: 'Dried Fish', included: true, allergen: true },
      { name: 'Palm Oil', included: true, allergen: false },
      { name: 'Traditional Spices', included: true, allergen: false },
    ],
    customizations: [
      { name: 'Extra Meat', price: 1500, popular: true },
      { name: 'Extra Fish', price: 1200, popular: false },
      { name: 'Add Gbegiri Soup', price: 800, popular: true },
      { name: 'Extra Amala', price: 600, popular: false },
      { name: 'No Fish Option', price: 0, popular: false },
    ],
    allergens: ['Fish'],
    dietaryInfo: ['Traditional', 'Rich in Iron'],
    location: {
      address: '10 Awolowo Road, Ikoyi, Lagos',
      distance: '2.5 km',
      deliveryTime: '25-35 mins',
      deliveryFee: 1500,
    },
    ...
    tags: ['Traditional', 'Yoruba', 'Comfort Food'],
  },
  5: {
    name: 'Pounded Yam and Egusi Soup',
    price: 4200,
    originalPrice: 5000,
    description: 'Smooth pounded yam served with rich Egusi soup made with ground melon seeds, spinach, and your choice of protein. A Nigerian classic.',
    image: 'https://images.pexels.com/photos/5835350/pexels-photo-5835350.jpeg',
    rating: 4.9,
    reviews: 845,
    chef: {
      name: 'Chef Nneka Obi',
      restaurant: 'Nigerian Flavors',
      image: 'https://images.pexels.com/photos/3771106/pexels-photo-3771106.jpeg',
      experience: '18 years',
      speciality: 'Nigerian Soups',
      rating: 4.8,
    },
    calories: 580,
    prepTime: '30-35 min',
    ...
    ingredients: [
      { name: 'Fresh Yam', included: true, allergen: false },
      { name: 'Ground Melon Seeds (Egusi)', included: true, allergen: false },
      { name: 'Spinach', included: true, allergen: false },
      { name: 'Assorted Meat', included: true, allergen: false },
      { name: 'Dried Fish', included: true, allergen: true },
      { name: 'Palm Oil', included: true, allergen: false },
      { name: 'Traditional Spices', included: true, allergen: false },
    ...
    customizations: [
      { name: 'Extra Meat', price: 1500, popular: true },
      { name: 'Extra Fish', price: 1200, popular: false },
      { name: 'Add Stockfish', price: 1000, popular: true },
      { name: 'Extra Pounded Yam', price: 800, popular: true },
      { name: 'No Fish Option', price: 0, popular: false },
    ],
    allergens: ['Fish'],
    dietaryInfo: ['High Protein', 'Rich in Vitamins'],
    location: {
    ...
    tags: ['Traditional', 'Popular', 'Comfort Food'],
  },
  6: {
    name: 'Suya Platter',
    price: 6500,
    originalPrice: 7500,
    description: 'Premium beef suya (Nigerian kebab) marinated in special suya spice, grilled to perfection, and served with fresh onions, tomatoes, and pepper sauce.',
    ...
    ingredients: [
      { name: 'Premium Beef', included: true, allergen: false },
      { name: 'Suya Spice', included: true, allergen: false },
      { name: 'Fresh Onions', included: true, allergen: false },
      { name: 'Tomatoes', included: true, allergen: false },
      { name: 'Pepper Sauce', included: true, allergen: true },
    ],
    customizations: [
      { name: 'Extra Meat', price: 2500, popular: true },
      { name: 'Add Chicken Suya', price: 2000, popular: true },
      { name: 'Extra Spicy', price: 0, popular: true },
      { name: 'Add Fried Yam', price: 1200, popular: false },
      { name: 'Extra Vegetables', price: 500, popular: false },
    ],
    allergens: ['Contains Peppers'],
    dietaryInfo: ['High Protein', 'Low Carb', 'Keto-Friendly'],
    location: {
    ...
    tags: ['Grilled', 'Spicy', 'Popular', 'Nigerian'],
  },
  7: {
    name: 'Fried Rice Special',
    price: 4800,
    originalPrice: 5500,
    description: 'Nigerian-style fried rice with mixed vegetables, shrimp, chicken, and a blend of local spices. Served with coleslaw and plantain.',
    ...
    ingredients: [
      { name: 'Long Grain Rice', included: true, allergen: false },
      { name: 'Chicken', included: true, allergen: false },
      { name: 'Shrimp', included: true, allergen: true },
      { name: 'Mixed Vegetables', included: true, allergen: false },
      { name: 'Plantain', included: true, allergen: false },
      { name: 'Coleslaw', included: true, allergen: false },
    ],
    customizations: [
      { name: 'Extra Chicken', price: 1500, popular: true },
      { name: 'Extra Shrimp', price: 2000, popular: false },
      { name: 'No Shrimp', price: 0, popular: false },
      { name: 'Extra Plantain', price: 800, popular: true },
      { name: 'Extra Rice', price: 1000, popular: false },
    ],
    allergens: ['Shellfish (Shrimp)'],
    dietaryInfo: ['Shellfish-Free Option Available'],
    location: {
...
export default function FoodDetail() {
  ...
  const foodItem = foodDatabase[Number(id) || 1] || foodDatabase[1];
  ...
  const renderChef = () => (
    <View style={styles.tabContent}>
      <View style={styles.chefCard}>
        <Image 
          source={{ uri: foodItem.chef.image }}
